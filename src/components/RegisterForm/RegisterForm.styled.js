...
export const FormContainer = styled.form` margin: 0 auto;
display:flex;
...
export const FromInput = styled.input` height: 20px;
margin-bottom: 8px;
border-top: 1px;
border-left: 1px;
border-right: 1px;
...
export const SubmitButton = styled.button` width: 150px;
margin: 0 auto;
padding: 5px;
font-weight: 700;
text-transform: uppercase;
